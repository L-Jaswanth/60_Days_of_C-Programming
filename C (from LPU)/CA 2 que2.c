/*
Q2: Create a float array. Enter and display the data. After that take the number to be deleted 
from the user, if number exist then delete the number otherwise insert the number at the end 
of array.
*/
