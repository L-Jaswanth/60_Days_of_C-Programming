/* Write a program using function without Return Type and with Parameter to enter the numbers 
    till the user wants and at the end it should display the count of even, odd and prime numbers
    entered 
*/
